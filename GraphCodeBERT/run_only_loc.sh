...
# output_dir=saved_models/my_data_only_localization;
# output_dir=saved_models/my_data_only_localization_two_relu;
output_dir=saved_models/my_data_only_localization_one_relu;
...
function evaluate () {
    ...
    test_model=$output_dir/checkpoint-best-acc/pytorch_model.bin #checkpoint for test
