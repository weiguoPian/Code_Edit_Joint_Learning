...
# PRETRAINDIR="facebook/mbart-large-cc25";

# PRETRAINED_MODEL_NAME=checkpoint_11_100000.pt;
# PRETRAINDIR=../models/pretrained/checkpoints/${PRETRAINED_MODEL_NAME};

# PRETRAINDIR="uclanlp/plbart-large";
# PRETRAINDIR='uclanlp/plbart-java-en_XX';
PRETRAINDIR="uclanlp/plbart-base";
...
# output_dir=saved_models/${data_name}_PLBART_base_step_4_bs_8;
output_dir=saved_models/${data_name}_PLBART_base_only_loc_step_4_bs_8_no_smooth;
